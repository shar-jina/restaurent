...
export default function Hero() {
  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      />
      <div className="absolute inset-0 bg-gradient-to-r from-primary-bg/95 via-primary-bg/75 to-transparent" />
      <div className="absolute inset-0 bg-gradient-to-t from-primary-bg via-transparent to-primary-bg/30" />
      ...
      <div className="absolute inset-0 opacity-20 pointer-events-none">
        ...
        <div className="absolute top-1/2 left-10 w-2 h-2 bg-gold/50 rounded-full animate-bounce duration-3000" />
      </div>
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full z-10">
        <div className="max-w-2xl text-left">
          ...
          >
            Taste the <span className="gold-gradient-text">Authentic</span> Flavors of Kerala
          </motion.h1>
          ...
          <motion.p
            ...
            className="font-sans text-gray-300 text-base sm:text-lg md:text-xl leading-relaxed mb-8 max-w-xl"
          >
            Experience delicious food prepared with fresh ingredients, traditional spices, and time-honored recipes from the heart of Southern India.
          </motion.p>
